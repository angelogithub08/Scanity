...
export class ProductsController {
  ...
  @ApiOperation({ summary: 'Gerar código de barras único' })
  @ApiResponse({
    status: 200,
    description: 'Código de barras único gerado com sucesso.',
  })
  generateBarcode(@CurrentUser() user: User) {
    return this.productsService.generateUniqueBarcode(user.account_id);
  }
