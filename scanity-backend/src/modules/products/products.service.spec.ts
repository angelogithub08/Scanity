...
describe('ProductsService', () => {
  ...
  const mockPaginatedResult: PaginatedResult<Product> = {
    data: [{ ...mockProduct, image: null } as unknown as Product],
    total: 1,
    page: 1,
    last_page: 1,
  };
  ...
  const mockS3Service = {
    generateSignedUri: jest.fn().mockResolvedValue('https://signed-url.com/image.jpg'),
      ...
      providers: [
        ...
        },
        {
          ...
          useValue: {
            ...
            findOneByBarcode: jest.fn().mockResolvedValue(null),
