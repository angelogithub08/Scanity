<template>
  ...
  >
    ...
    <q-scroll-area style="height: calc(100vh - 102px)" class="q-pa-sm">
      <MostMovedProductsReportFilters
        ref="filterRef"
...
import MostMovedProductsReportFilters from './MostMovedProductsReportFilters.vue';
...
const filterRef = ref<InstanceType<typeof MostMovedProductsReportFilters> | null>(null);
