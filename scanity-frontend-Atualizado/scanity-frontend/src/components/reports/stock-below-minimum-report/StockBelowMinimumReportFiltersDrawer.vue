<template>
  ...
  >
    ...
    <q-scroll-area style="height: calc(100vh - 102px)" class="q-pa-sm">
      <StockBelowMinimumReportFilters
        ref="filterRef"
...
import StockBelowMinimumReportFilters from './StockBelowMinimumReportFilters.vue';
...
const filterRef = ref<InstanceType<typeof StockBelowMinimumReportFilters> | null>(null);
