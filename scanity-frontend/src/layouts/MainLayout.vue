    ...
    >
      <q-scroll-area class="drawer-scroll">
        ...
        <q-list>
          ...
          <q-item
            v-permission="'REPORT_PRODUCTS_IN_STOCK'"
            clickable
            v-ripple
            :to="{ name: 'report-stock-products' }"
            class="nav-item"
            active-class="nav-item-active"
            dense
          >
            <q-item-section avatar>
              <q-icon name="inventory_2" class="nav-icon" size="20px" />
            </q-item-section>
            <q-item-section>
              <q-item-label class="nav-label">Produtos em estoque</q-item-label>
              <q-item-label caption class="nav-caption">Quantidade por produto</q-item-label>
            </q-item-section>
          </q-item>
          <q-item
            v-permission="'REPORT_STOCK_BELLOW_MINIMUM'"
            clickable
            v-ripple
            :to="{ name: 'report-stock-below-minimum' }"
            class="nav-item"
            active-class="nav-item-active"
            dense
          >
            <q-item-section avatar>
              <q-icon name="warning" class="nav-icon" size="20px" />
            </q-item-section>
            <q-item-section>
              <q-item-label class="nav-label">Produtos abaixo do mínimo</q-item-label>
              <q-item-label caption class="nav-caption">Estoque abaixo do mínimo</q-item-label>
            </q-item-section>
          </q-item>
          <q-item
            v-permission="'REPORT_STOCK_MOVEMENTS'"
            clickable
            v-ripple
            :to="{ name: 'report-stock-movements' }"
            class="nav-item"
            active-class="nav-item-active"
            dense
          >
            <q-item-section avatar>
              <q-icon name="swap_horiz" class="nav-icon" size="20px" />
            </q-item-section>
            <q-item-section>
              <q-item-label class="nav-label">Movimentações de estoque</q-item-label>
              <q-item-label caption class="nav-caption"
                >Histórico de entradas e saídas</q-item-label
              >
            </q-item-section>
          </q-item>
          <q-item
            v-permission="'REPORT_MOST_MOVED_PRODUCTS'"
            clickable
            v-ripple
            :to="{ name: 'report-most-moved-products' }"
            class="nav-item"
            active-class="nav-item-active"
            dense
          >
            <q-item-section avatar>
              <q-icon name="trending_up" class="nav-icon" size="20px" />
            </q-item-section>
            <q-item-section>
              <q-item-label class="nav-label">Produtos mais movimentados</q-item-label>
              <q-item-label caption class="nav-caption">Ranking por entradas e saídas</q-item-label>
            </q-item-section>
          </q-item>
          ...
          <q-item
            v-permission="'MOVEMENT_STAGES_LIST'"
            clickable
            v-ripple
            :to="{ name: 'movement-stages' }"
            class="nav-item"
            active-class="nav-item-active"
          >
            <q-item-section avatar>
              <q-icon name="flag" class="nav-icon" />
            </q-item-section>
            <q-item-section>
              <q-item-label class="nav-label">Etapas de Movimentação</q-item-label>
              <q-item-label caption class="nav-caption"
                >Gerencie as etapas de movimentação</q-item-label
              >
            </q-item-section>
          </q-item>

          <q-item
            v-permission="'INVENTORY_LIST'"
            clickable
            v-ripple
            :to="{ name: 'inventory-counts' }"
            class="nav-item"
            active-class="nav-item-active"
          >
            <q-item-section avatar>
            ...
            <q-item-section>
              <q-item-label class="nav-label">Inventário</q-item-label>
              <q-item-label caption class="nav-caption"> Gerencie a inventários </q-item-label>
            </q-item-section>
          </q-item>

          <q-item
            v-permission="'SUPLIERS_LIST'"
            clickable
            v-ripple
            :to="{ name: 'supliers' }"
            class="nav-item"
          ...
          >
            <q-item-section avatar>
              <q-icon name="factory" class="nav-icon" />
            </q-item-section>
            <q-item-section>
              <q-item-label class="nav-label">Fornecedores</q-item-label>
              <q-item-label caption class="nav-caption">Gerencie os fornecedores</q-item-label>
            </q-item-section>
          </q-item>

          <q-item
            v-permission="'CUSTOMERS_LIST'"
            clickable
            v-ripple
            :to="{ name: 'customers' }"
            class="nav-item"
          ...
          >
            ...
            <q-item-section>
              <q-item-label class="nav-label">Clientes</q-item-label>
              <q-item-label caption class="nav-caption">Gerencie os clientes</q-item-label>
            </q-item-section>
          </q-item>

          <q-item
            v-permission="'TOKENS_LIST'"
            clickable
            v-ripple
            :to="{ name: 'tokens' }"
            class="nav-item"
          ...
          >
            ...
            <q-item-section>
              <q-item-label class="nav-label">Perfis</q-item-label>
              <q-item-label caption class="nav-caption">Gerencie os perfis</q-item-label>
            </q-item-section>
          </q-item>
        </q-list>
      </q-scroll-area>
...
onBeforeMount(async () => {
  ...
  try {
    ...
    const permissions = await permissionsResource.list({ profile_id: user.data.profile_id });
    authStore.setPermissions(permissions.data);
